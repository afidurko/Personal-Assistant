...
Keep the neural mesh coherent across nulltickets store, persistence bundle, and
smart-second-brain vault topics.
Include `mesh/cline` (coding sessions across workspaces) alongside Jarvis/vault.
