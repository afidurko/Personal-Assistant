...
HARD_PATHS = [
    ...
    "scripts/presence-check.py",
    "config/persona/avatar.json",
    "config/persona/converse-overlays.json",
    "scripts/converse_overlays.py",
    "scripts/converse-overlays-check.py",
    "scripts/converse-parity-check.py",
    "scripts/converse-billion-fuzz.py",
    "shared/converseOverlays.ts",
    "companions/web/converse-overlays.js",
    ...
    "config/integrations/higgsfield.md",
    "config/integrations/higgsfield-nodes.example.json",
    "scripts/testdata/sample-higgsfield-experiment.py",
    ...
    "scripts/higgsfield-check.py",
    "scripts/higgsfield-run.py",
