...
- workspace-unit-tests: exit=0 wall=5.5s
- cloud-agent-install: exit=0 wall=0.7s
- cam-system-unit: exit=0 wall=0.6s
- cam-reason-unit: exit=0 wall=2.1s
- converse-voice-unit: exit=0 wall=3.6s
- higgsfield-check: exit=0 wall=0.8s
- higgsfield-unit: exit=0 wall=3.0s
- embodiment-lite: exit=0 wall=0.7s
- presence-check: exit=0 wall=0.3s
- trajectory-policy-check: exit=0 wall=0.3s
- predictive-cortex-unit: exit=0 wall=4.1s
- research-ethics-check: exit=0 wall=0.3s
- connectome-3t: exit=0 wall=4.7s
- illa-desktop-unit: exit=0 wall=2.6s
- illa-electron-check: exit=0 wall=1.3s
- public-apis-unit: exit=0 wall=2.1s
- public-apis-addons-unit: exit=0 wall=4.3s
- public-apis-check: exit=0 wall=3.5s
...
- illa-desktop-3t: exit=0 wall=3.2s
- aaron-voice-3t: exit=0 wall=3.4s
- public-apis-3t: exit=0 wall=4.8s
- predictive-cortex-3t: exit=0 wall=70.1s
