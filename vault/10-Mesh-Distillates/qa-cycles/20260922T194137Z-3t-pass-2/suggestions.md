...
## Results
- ci-static-gate: exit=0 wall=1.3s
- workspace-unit-tests: exit=0 wall=7.4s
- cloud-agent-install: exit=0 wall=0.7s
- cam-system-unit: exit=0 wall=1.1s
- cam-reason-unit: exit=0 wall=1.6s
...
- presence-check: exit=0 wall=2.2s
- trajectory-policy-check: exit=0 wall=0.4s
- predictive-cortex-unit: exit=0 wall=4.2s
- research-ethics-check: exit=0 wall=2.3s
...
- embodiment-3t: exit=0 wall=3.1s
...
- predictive-cortex-3t: exit=0 wall=69.9s
