...
## Results
- ci-static-gate: exit=0 wall=1.0s
- workspace-unit-tests: exit=0 wall=8.6s
- cloud-agent-install: exit=0 wall=0.7s
- cam-system-unit: exit=0 wall=0.8s
- cam-reason-unit: exit=0 wall=1.7s
- converse-voice-unit: exit=0 wall=0.5s
...
- predictive-cortex-unit: exit=0 wall=3.9s
- research-ethics-check: exit=0 wall=0.4s
- connectome-3t: exit=0 wall=4.9s
- illa-desktop-unit: exit=0 wall=1.4s
- illa-electron-check: exit=0 wall=1.1s
- public-apis-unit: exit=0 wall=2.4s
- public-apis-addons-unit: exit=0 wall=3.6s
- public-apis-check: exit=0 wall=0.7s
- trajectory-3t: exit=0 wall=1.6s
- embodiment-deps-offline: exit=0 wall=8.6s
- embodiment-3t: exit=0 wall=2.8s
- cam-reason-3t: exit=0 wall=10.7s
- illa-desktop-3t: exit=0 wall=3.4s
- aaron-voice-3t: exit=0 wall=1.6s
- public-apis-3t: exit=0 wall=8.9s
- predictive-cortex-3t: exit=0 wall=71.1s
