...
- Shared sensory periphery (now includes arXiv/AGI feeds + daily clock + sLM/DL feedback + Cline results)
- Specialized higher centers + hotspots (**coding**, **agi_scan**, **enhance**, **capability**, **info**, **slm**, **dl**)
...
Repo docs: `docs/CONNECTOME_ARCHITECTURE.md` · `docs/CAM_BRAIN.md`  
...
Research source: [[2026-09-16-Drosophila-male-CNS-connectome-Cell]] · [[AGI-Daily-Scan]]
