...
| **Integration submodules** | Jarvis · PaddleDetection · LLMAvatarTalk · smart-second-brain · MemoryBear · Cline · SwiftGuide | **Declared but empty until `git submodule update --init --recursive`** |
