...
| **Integration submodules** | Jarvis · PaddleDetection · LLMAvatarTalk · VoiceStudio · smart-second-brain · public-apis · Cline · **Inkbox** | **Declared; init with `git submodule update --init --recursive`** |
