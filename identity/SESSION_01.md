...
Machine-readable copy: [`ANSWERS_SESSION_01.json`](ANSWERS_SESSION_01.json)  
Compiled profile: [`PROFILE.md`](PROFILE.md)

Boot order: persistence → research → careers (LinkedIn/Indeed) → life ops → comms → docs → vision  
See `config/priority-boot.json`.
